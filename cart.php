	...
	<div class="navbar navbar-default navbar-fixed-top" id="topnav">
		<div class="container-fluid">
			<div class="navbar-header">
				<a href="index.php" class="navbar-brand">Gift Corner</a>
			</div>
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="row">
				...
				<form><input type="submit" name="submit" class='btn btn-success btn-lg pull-right' id='checkout_btn' data-toggle="modal" data-target="#myModal" value="Checkout"></form>
				<!-- <button class='btn btn-success btn-lg pull-right' name="submit" id='checkout_btn' data-toggle="modal" data-target="#myModal">Checkout</button> -->
			</div>
