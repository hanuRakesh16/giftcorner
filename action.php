<?php 
	...
	if(isset($_POST["category"])){
		...
		echo "<div class='nav nav-pills nav-stacked'>
					<li class='active'><a href='#'><h4>Shops</h4></a></li>";
	...
	if(isset($_POST["brand"])){
		...
		$run_query=mysqli_query($conn,$category_query);
		echo "<div class='nav nav-pills nav-stacked'>
					<li class='active'><a href='#'><h4>Types</h4></a></li>";
		if(mysqli_num_rows($run_query)){
			while($row=mysqli_fetch_array($run_query)){
				$bid=$row['brand_id'];
				...
				echo "<div class='col-md-4'>
							<div class='panel panel-info'>
								...
								<a href='#' class='imageproduct' pid='$pro_id'>
									<img src='assets/prod_img/$img' style='width:200px; height:250px;' >
								</a>
								</div>
		...
		while($row=mysqli_fetch_array($run_query)){
			$pro_id=$row['product_id'];
				...
				echo "<div class='col-md-4'>
							<div class='panel panel-info'>
								<div class='panel-heading'>$title</div>
								<div class='panel-body' class='imageproduct' pid='$pro_id'><img src='assets/prod_img/$img' style='width:200px; height:250px;'></div>
								<div class='panel-heading'>Rs $price
		...
		while($row=mysqli_fetch_array($run_query))
		{
			...
			if(isset($_POST['cartmenu']))
			{
				...
				<div class='row'>
									...
									<div class='col-md-3'><img src='assets/prod_img/$product_image' width='60px' height='60px'></div>
			...
			else
			{
				echo "
					<div class='row'>
						...
						<div class='col-md-2'><img src='assets/prod_img/$product_image' width='60px' height='60px'></div>
		...
		echo "
				<div class='row'>
					<div class='col-md-6 pull-right'>
						<img src='assets/prod_img/$image' style='width:250px;height:300px;'>
					</div>
					<div class='col-md-6'>
